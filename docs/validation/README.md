...
汇总截至 2026-09-09 的已有证据。各轮提交不同，下面不是当前工作树完整回归报告；构建、模拟器、真机和用户反馈分开记录。历史逐步日志查 Git，本机 `.tooling/evidence/` 不随仓库提供。
...
PARSE-001/002/006/007/003/005/008 已实现，PARSE-004 按用户手动验收结论收口完成：清理前完整离线 559 项、分析和格式检查通过；后续经用户授权，Android 12 真机主要流程通过（导入、目录、图文、重解析、脚注返回、重启续读），取消未测；iOS 用户确认重解析后特殊排版正常并确认整体收口。支持范围见[解析矩阵](epub-support-profile.md)，设备记录与步骤见[PARSE-004](parse-004.md)。历史 iPhone 结果不替代本轮重解析与辅助链接验收。

...
| 12. 发布产物 | GitHub Release 增加 Windows | 第一版直接发布 `shiori-reader-vX.Y.Z-windows-x64.zip` | Release 同时提供 Android APK 与 Windows ZIP | P1 | ◐ ZIP 打包及双平台统一发布已接入；待远端 ZIP 验包，真实 tag 发布另行验证 |

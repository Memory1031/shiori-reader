...
abstract final class ShioriLayout {
  ...
  static const detail = 1040.0, detailColumns = 880.0;
  static const detailSide = 200.0, detailSideWide = 240.0, detailGap = 40.0;

  /// A desktop page frame's inset from the workspace edge in a window
  /// [width] wide: [shelfGutterWide] from the sidebar breakpoint, otherwise
  /// [shelfGutter].
  static double gutter(double width) =>
      width >= sidebarBreakpoint ? shelfGutterWide : shelfGutter;
}

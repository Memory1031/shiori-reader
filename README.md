...
- **桌面阅读** — Windows 支持文件拖入、键盘 / 滚轮翻页与宽屏正文双页；正文整页插图可与相邻页配对，纯图片章节和原版式页面保持限宽居中。
- **桌面工作区** — 书架、搜索、本地文件、离线内容、关于与更新及详情使用桌面导航与稳定工具栏；阅读器全窗口打开，返回后恢复原页面栈。

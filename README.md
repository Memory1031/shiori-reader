...
> 当前用于个人与私下测试。平台支持范围不代表所有系统版本均已完成实测；构建与设备验证情况见[验收记录](docs/release/README.md#110-验收范围)。
...
旧导入记录不会随应用升级自动重建。若 EPUB 特殊排版异常，或需要应用新的兼容规则，请进入「更多 → 本地文件 → 书籍菜单 → 重新解析」，完成后重新打开；无需删除重导。当前准备中的更新见 [1.1.0 更新说明](docs/release/notes/v1.1.0.md)。
...
| [当前范围](docs/TASK_PLAN.md) / [验收记录](docs/release/README.md#110-验收范围) | 待办事项与实际验证证据 |
